...
import com.appschef.intern.minimarket.exception.ValidationException;
...
public class ErrorController {
    ...
    public ResponseEntity<WebResponse<Map<String, String>>> validationException(ValidationException exception){
